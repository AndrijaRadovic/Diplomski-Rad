...
const ReceiptForm = () => {
    ...
    const handleSaveReceipt = async () => {
        ...
        try {
            ...
            toast.error("Error saving receipt", error);
        }
    };
            ...
            <div className="receipt-form">
                ...
                <div className="receipt-form-inputs">
                    ...
                    <select
                        ...
                        //     handleSearch(term);  // Pretraga direktno pri promeni
                        //     const product = filteredProducts.find(p => p.sifraProizvoda === Number(term));
                        //     setSelectedProduct(product);
                        // }}
                    >
                    ...
                    {/* <Select styles={{
                        ...
                        value={selectedProduct ? { value: selectedProduct.sifraProizvoda, label: selectedProduct.nazivProizvoda } : null}
                        onChange={(selectedOption) => {
                            const product = products.find(p => p.sifraProizvoda === selectedOption.value);
                            setSelectedProduct(product);
                        }}
                        options={products.map(product => ({
                            value: product.sifraProizvoda,
                            label: product.nazivProizvoda
                        }))}
                        isSearchable={true}
                        placeholder="Izaberi ili pretraži proizvod..."
                    /> */}
                    <input
                        type="number"
                ...
                <div className="receipt-form-buttons">
                    ...
                    <button onClick={handleSaveReceipt}>Sačuvaj Račun</button>
                </div>
            </div>
        </div>
    );
